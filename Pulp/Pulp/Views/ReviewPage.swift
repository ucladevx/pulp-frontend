...
import UIKit
    ...
    class PopUpWindow: UIView {
        ...
        override init(frame: CGRect) {
            ...
            reviewText.centerYAnchor.constraint(equalTo:reviewTextView.centerYAnchor).isActive = true
            reviewText.heightAnchor.constraint(equalTo: reviewTextView.heightAnchor ).isActive = true
            reviewText.widthAnchor.constraint(equalTo: reviewTextView.widthAnchor ).isActive = true
            reviewText.font = UIFont(name: "Avenir-Light", size: 20)
...
extension PopUpWindow: FloatRatingViewDelegate {
