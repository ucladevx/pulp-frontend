...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Pulp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Pulp11AppDelegate")
...
SWIFT_CLASS("_TtC4Pulp27CreateProfileViewController")
...
SWIFT_CLASS("_TtC4Pulp18Explore_Controller")
@interface Explore_Controller : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC4Pulp8FeedCell")
...
SWIFT_CLASS("_TtC4Pulp14FeedController")
@interface FeedController : UICollectionViewController <UICollectionViewDelegateFlowLayout>
- (void)viewDidLoad;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC4Pulp15LogInController")
...
SWIFT_CLASS("_TtC4Pulp8PageCell")
...
SWIFT_CLASS("_TtC4Pulp11ProductCell")
...
SWIFT_CLASS("_TtC4Pulp21ResultsViewController")
...
SWIFT_CLASS("_TtC4Pulp20ReviewCollectionCell")
...
SWIFT_CLASS("_TtC4Pulp24SelectInterestController")
@interface SelectInterestController : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4Pulp17SwipingController")
@interface SwipingController : UICollectionViewController <UICollectionViewDelegateFlowLayout>
- (void)viewDidLoad;
